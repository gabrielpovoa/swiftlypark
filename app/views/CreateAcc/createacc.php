...
<section class="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-700/80 to-blue-900/90 px-4">
    ...
    <div class="w-full max-w-xl bg-gradient-to-br from-blue-800/80 to-blue-900/95 shadow-xl rounded-2xl px-8 py-10">

        <h2 class="text-white text-3xl mb-8 font-bold text-center tracking-wide">Criar Conta</h2>
        ...
        <form action="/CreateAcc/create" method="POST" class="space-y-6">
            ...
            <div class="flex flex-col">
                <label for="name" class="text-white font-semibold mb-2">Nome</label>
    ...
    <div class="flex items-center justify-center mt-6">
        <p class="text-white text-sm">
            Já possui uma conta?
            <a href="/login" class="ml-2 px-4 py-2 bg-blue-600/80 hover:bg-blue-500/80 rounded-2xl text-white font-semibold shadow-md hover:shadow-lg transition-all duration-300">
                Acesse aqui!
            </a>
        </p>
    </div>
