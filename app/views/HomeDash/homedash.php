...
<section class="p-6 flex flex-col gap-6 min-h-screen w-full bg-gray-900">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
        ...
        <div class="flex flex-col gap-4 lg:col-span-1">
            ...
            <!-- Moto -->
            <div class="flex flex-col items-center justify-center bg-gradient-to-br from-blue-700/80 to-blue-900/80 rounded-xl shadow-lg p-4 hover:scale-105 transition-transform duration-300">
            ...
            <div class="flex gap-4">
                <!-- Caminhão -->
                <div class="flex flex-col items-center justify-center bg-gradient-to-br from-blue-700/80 to-blue-900/80 rounded-xl shadow-lg p-4 hover:scale-105 transition-transform duration-300 flex-1">
        ...
        <!-- Log -->
        <div class="h-96 lg:col-span-3 bg-gradient-to-br from-blue-700/80 to-blue-900/80 text-white rounded-xl shadow-lg p-6 flex flex-col">
            <div class="flex justify-between items-center border-b border-blue-400 pb-2 mb-4">
                ...
                <button
                        ...
                        class="js-print-logs flex items-center gap-1 px-3 py-1 bg-white text-blue-700 font-semibold rounded hover:bg-blue-700 hover:text-white transition-colors duration-300 text-sm"
                        id="btn-print-logs">
                ...
                <ul class="flex flex-col gap-2 overflow-y-auto max-h-96 pr-2">
                    <?php foreach ($logEntry as $log): ?>
                        ...
                        <li class="flex justify-between items-center p-2 rounded-lg transition-colors duration-200
                            <?= $log['tipo'] === 'entrada' ? 'bg-green-600/20 hover:bg-green-600/40' : 'bg-red-600/20 hover:bg-red-600/40' ?>">
                            <div class="flex items-center gap-3">
                                <i data-lucide="<?= $icon ?>" class="w-5 h-5 <?= $cor ?>"></i>
                                <span class="text-sm font-medium">
                                    <strong><?= htmlspecialchars($log['placa']) ?></strong> (<?= ucfirst($tipoVeiculo) ?>) <?= $log['tipo'] ?>
                                </span>
                            </div>
    ...
    <!-- Faturamento -->
    <div class="bg-gradient-to-br from-blue-700/80 to-blue-900/80 p-6 rounded-xl shadow-lg flex flex-col md:flex-row justify-between items-center gap-4 mt-4">
        <div>
        ...
        <a href="/vacancy"
           class="p-6 bg-white text-blue-700 font-semibold rounded-xl shadow-lg hover:bg-blue-700 hover:text-white transition-colors duration-300 text-center">
            Ver Vagas
        </a>
    </div>
