<div class="group relative">
    ...
    <aside class="group fixed top-0 left-0 h-full bg-blue-600 text-white flex flex-col overflow-hidden w-14 hover:w-60 transition-all duration-300 z-50">
        ...
        <a href="/sobre" class="flex items-center gap-3 px-4 group-hover:px-4 py-3 hover:bg-blue-700 transition-all duration-300">
